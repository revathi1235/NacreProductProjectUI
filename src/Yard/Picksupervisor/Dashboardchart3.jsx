...
function GaugeChartWithEffect(props) {
  const [completedpicklist,setCompletedpicklist]=useState('')
   ...
   useEffect(() => {
     ...
     const fetchData = async () => {
         try {
             ...
             setCompletedpicklist(response.Completed_Picks)
             console.log("res of apex chart5 page",response );
...
console.log(labels);
  ...
  const zones = [
    ...
    { strokeStyle: '#FFDD00', min: values[4], max: completedpicklist },
  ];
